  ...
  return (
    <div className='mx-36 border border-black'>
      ...
      <section>
          ...
          <div className='flex w-[39.95%] border-black  border-b'>
            <div className='flex w-[85%] border-r border-black '>
              <div className='flex flex-col w-[9.09%] border-r border-black'>
                <div className='flex h-[84.5%] justify-center items-center'></div>
        ...
        {/* Filas de datos */}
        <div className='flex '>
          <div className='flex h-8 w-[2%] text-center border-r border-black '></div>
          <div className='flex h-8 w-[5.5%] text-center border-r border-black'></div>
          <div className='flex h-8 w-[40.5%] text-center border-r border-black'></div>
          <div className='flex h-8 w-[3%] text-center border-r border-black'></div>
          <div className='flex h-8 w-[3%] text-center border-r border-black'></div>
          <div className='flex h-8 w-[2.95%] text-center border-r border-black'></div>
          <div className='flex h-8 w-[3.1%] text-center border-r border-black'></div>
          <div className='flex h-8 w-[3.06%] text-center border-r border-black'></div>
          <div className='flex h-8 w-[3.1%] text-center border-r border-black'></div>
          <div className='flex h-8 w-[3.06%] text-center border-r border-black'></div>
          <div className='flex h-8 w-[3.1%] text-center border-r border-black'></div>
          <div className='flex h-8 w-[3.1%] text-center border-r border-black'></div>
          ...
          <div className='flex h-8 w-[3.1%] text-center border-r border-black'></div>
          <div className='flex h-8 w-[3.06%] text-center border-r border-black'></div>
          <div className='flex h-8 w-[3.2%] text-center border-r border-black'></div>
          <div className='flex h-8 w-[5.91%] text-center '></div>
        </div>
