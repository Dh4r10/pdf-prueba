...
function ModelPDF() {
  return (
    <div className="mx-36 border border-black">
              ...
              <div className="flex w-[39.95%] border-black  border-b">
                <div className="flex w-[85%] border-r border-black ">
                  <div className="flex flex-col w-[9.09%] border-r border-black">
                    <div className="flex h-[84.5%] justify-center items-center transform -rotate-90 origin-center whitespace-nowrap w-36 pb-20">
                      Interes continu
                    </div>
      ...
      <div className="m-7">
        <button className="border border-blue-500 bg-blue-400 p-4 text-2xl">
          <PDFDownloadLink document={<PDF />} fileName="registro_matricula.pdf">
